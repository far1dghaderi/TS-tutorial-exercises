...
var Eventing_1 = require("./Eventing"); //K is the structure of the data that our clas must deal with it
...
function () {
  function Attributes(data) {
    ...
    this.data = data; //This syntax below makes sure that our input values to the method are a
...
exports.View = void 0; //because we should have all of Model methods and props in our View class, So we just extend a generic from it
...
function () {
  ...
  View.prototype.onRender = function () {//nothing
  };
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9840" + '/');
